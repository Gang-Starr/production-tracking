...
Direkt unterhalb des Gefahrenbereichs steht der dezente Footer mit Autorenhinweis und Link zur Dokumentation. Auf Deutsch lautet er **„Production Tracking App · Concept & Prototype by JSE · 2026 · Dokumentation“**, auf Englisch **“Production Tracking App · Concept & Prototype by JSE · 2026 · Documentation”** und auf Italienisch **“Production Tracking App · Concept & Prototype by JSE · 2026 · Documentazione”**. Der Dokumentationslink öffnet `README.md` in einem neuen Tab. Der Footer nutzt dieselbe lokale Übersetzungslogik aus `script.js` wie die übrigen Oberflächentexte und wechselt mit der Sprachauswahl Deutsch / English / Italiano. Der Linktext wird über den eigenen i18n-Key `footerDocumentation` gepflegt; dieser Key ist für `de`, `en` und `it` hinterlegt und wird beim Sprachwechsel erneut auf den Footer-Link angewendet.
