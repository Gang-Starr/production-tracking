...
const translations = {
  de: {
    documentTitle: 'Produktionsstückzahlen & OEE lokal auswerten', languageAria: 'Sprache auswählen', headerEyebrow: 'RAMP-UP MONITORING TOOL', headerTitle: 'Production Ramp-up Tracker', headerSubtitle: 'Tägliche Produktionsdaten erfassen, Abweichungen erkennen und Ramp-up transparent steuern.', headerNotice: 'Offene Test-App – nur freigegebene Produktionsdaten eingeben. Keine personenbezogenen Daten.', workflowHint: 'Ablauf Daten verwalten', workflowStepEnter: 'Daten eingeben', workflowStepCheck: 'Einträge prüfen', workflowStepExport: 'CSV exportieren', workflowStepSend: 'CSV per E-Mail zurücksenden', languageLabel: 'Sprache', languageGerman: 'Deutsch', languageEnglish: 'English', languageItalian: 'Italiano', formTitle: 'Eintrag erfassen', storageNote: 'Lokal gespeichert', date: 'Datum', project: 'Projekt', part: 'Bauteil', machine: 'Maschine', targetPerDay: 'Zielmenge pro Tag', targetUnreleased: 'Noch keine freigegebene Zielmenge', entriesWithoutTarget: 'Einträge ohne freigegebene Zielmenge', producedQty: 'Produzierte Stückzahl', scrap: 'Ausschuss', optionalOee: 'Optionale OEE-Daten', showOeeData: 'OEE-Daten anzeigen', hideOeeData: 'OEE-Daten ausblenden', oeeHelp: 'Nur ausfüllen, wenn OEE berechnet werden soll.', showOeeColumns: 'OEE-Spalten anzeigen', hideOeeColumns: 'OEE-Spalten ausblenden', optional: '(optional)', plannedTime: 'Geplante Produktionszeit in Minuten', downtime: 'Maschinenstillstand in Minuten', cycleTime: 'Ideale Taktzeit je Stück in Sekunden', comment: 'Kommentar', commentField: 'Kommentar bei Abweichung > 10 %, Ausschuss oder Stillstand', saveEntry: 'Eintrag speichern', manageMasterData: 'Stammdaten verwalten', masterNote: 'Die App startet ohne Beispiel-Stammdaten. Neue Projekte, Bauteile und Maschinen entstehen durch Speichern, manuelles Hinzufügen oder CSV-Import.', newProject: 'Neues Projekt', newPart: 'Neues Bauteil', newMachine: 'Neue Maschine', addProject: 'Projekt hinzufügen', addPart: 'Bauteil hinzufügen', addMachine: 'Maschine hinzufügen', projectList: 'Projektliste', partList: 'Bauteilliste', machineList: 'Maschinenliste', managementSummary: 'Management-Zusammenfassung', totalGood: 'Gesamt-Gutmenge', totalScrap: 'Gesamt-Ausschuss', totalDeviation: 'Gesamt-Abweichung', avgAchievement: 'Ø Zielerreichung', avgAvailability: 'Ø Verfügbarkeit', avgPerformance: 'Ø Leistung', avgQuality: 'Ø Qualität', avgOee: 'Ø OEE aus gültigen OEE-Einträgen', oeeCount: 'Einträge mit OEE-Berechnung', noOeeCount: 'Einträge ohne OEE-Berechnung', manageData: 'Daten verwalten', exportCsv: 'CSV exportieren', exportSummary: 'Management-TXT exportieren', importCsv: 'CSV importieren', downloadCsvTemplate: 'CSV-Vorlage herunterladen', dailyOverview: 'Tagesübersicht', categorySums: 'Summen nach Kategorien', dashboard: 'Dashboard', autoCharts: 'Automatisch aktualisierte Balkendiagramme', projectFilter: 'Projektfilter', partFilter: 'Bauteilfilter', machineFilter: 'Maschinenfilter', goodPerDay: 'Gutmenge pro Tag', targetVsGood: 'Zielmenge vs. Gutmenge pro Tag', scrapPerDay: 'Ausschuss pro Tag', oeePerDay: 'OEE pro Tag', oeePartsPerDay: 'OEE-Bestandteile pro Tag', showOeeCharts: 'OEE-Diagramme anzeigen', hideOeeCharts: 'OEE-Diagramme ausblenden', cumulativeDeviation: 'Kumulierte Abweichung', allEntries: 'Alle Eingaben', entries: 'Einträge', noData: 'Noch keine Daten vorhanden.', noDataSummary: 'Noch keine Daten vorhanden. Erfassen oder importieren Sie Produktionsdaten, um eine Zusammenfassung zu erhalten.', allProjects: 'Alle Projekte', allParts: 'Alle Bauteile', allMachines: 'Alle Maschinen', target: 'Ziel', targetQty: 'Zielmenge', produced: 'Produziert', good: 'Gutmenge', deviation: 'Abweichung', targetPct: 'Ziel %', targetAchievement: 'Zielerreichung', availability: 'Verfügbarkeit', performance: 'Leistung', quality: 'Qualität', planTime: 'Planzeit', downtimeShort: 'Stillstand', cycleTimeShort: 'Taktzeit', availabilityShort: 'Verfüg.', oeePct: 'OEE %', action: 'Aktion', delete: 'Löschen', rename: 'Umbenennen', active: 'Aktiv', archived: 'Archiviert', changedOn: 'geändert am', goodShort: 'Gut', deviationShort: 'Abw.', noOeeData: 'Keine OEE-Daten vorhanden', invalidInput: 'Ungültige Eingabe.', noValue: 'Ohne Angabe', confirmDeleteEntry: 'Diesen Eintrag wirklich löschen?', importSuccess: 'CSV erfolgreich importiert.', validationDate: 'Bitte geben Sie ein Datum ein.', validationProject: 'Bitte ein Projekt eingeben oder auswählen.', validationPart: 'Bitte ein Bauteil eingeben oder auswählen.', validationMachine: 'Bitte eine Maschine eingeben oder auswählen.', validationComment: 'Bitte bei Abweichung, Ausschuss oder Stillstand einen kurzen Kommentar eintragen.', validationRequiredNumbers: 'Bitte füllen Sie Zielmenge, produzierte Stückzahl und Ausschuss mit gültigen Zahlen aus.', validationNegative: 'Negative Werte sind nicht erlaubt. Bitte korrigieren Sie die Eingabe.', validationTargetPositive: 'Die Zielmenge pro Tag muss größer als 0 sein.', validationProducedPositive: 'Die produzierte Stückzahl muss größer oder gleich 0 sein.', validationScrapTooHigh: 'Ausschuss darf nicht größer sein als produzierte Stückzahl.', validationPlannedPositive: 'Für die OEE-Berechnung muss die geplante Produktionszeit größer als 0 Minuten sein.', validationDowntimePositive: 'Für die OEE-Berechnung muss der Maschinenstillstand größer oder gleich 0 Minuten sein.', validationCyclePositive: 'Für die OEE-Berechnung muss die ideale Taktzeit größer als 0 Sekunden sein.', validationDowntimeTooHigh: 'Maschinenstillstand darf nicht größer sein als geplante Produktionszeit.', placeholderProject: 'Projekt eingeben oder auswählen', placeholderPart: 'Bauteil eingeben oder auswählen', placeholderMachine: 'Maschine eingeben oder auswählen', placeholderPlanned: 'z. B. 480', placeholderDowntime: 'z. B. 15', placeholderCycle: 'z. B. 1,2', placeholderComment: 'Bitte Ursache oder kurze Erläuterung eingeben', placeholderNewProject: 'Projektname eingeben', placeholderNewPart: 'Bauteilname eingeben', placeholderNewMachine: 'Maschinenname eingeben', noProjects: 'Keine Projekte vorhanden', noParts: 'Keine Bauteile vorhanden', noMachines: 'Keine Maschinen vorhanden', dangerZoneTitle: 'Gefahrenbereich', dangerZoneHint: 'Hier können alle lokal gespeicherten App-Daten dieses Browsers gelöscht werden.', resetAppButton: 'App zurücksetzen', resetConfirmMessage: 'Möchten Sie wirklich alle lokal gespeicherten App-Daten löschen? Dieser Vorgang kann nicht rückgängig gemacht werden.', resetConfirmInstruction: 'Bitte geben Sie RESET ein, um das Löschen zu bestätigen.', resetCancelButton: 'Abbrechen', resetDeleteButton: 'Endgültig löschen', footerCredit: 'Production Tracking App · Concept & Prototype by JSE · 2026', footerDocumentation: 'Dokumentation'
  },
  en: {
    documentTitle: 'Production quantities & OEE local analysis', languageAria: 'Select language', headerEyebrow: 'RAMP-UP MONITORING TOOL', headerTitle: 'Production Ramp-up Tracker', headerSubtitle: 'Capture daily production data, identify deviations and create transparency during ramp-up.', headerNotice: 'Open test app – only enter approved production data. No personal data.', workflowHint: 'Manage data workflow', workflowStepEnter: 'Enter data', workflowStepCheck: 'Check entries', workflowStepExport: 'Export CSV', workflowStepSend: 'Send CSV by email', languageLabel: 'Language', languageGerman: 'Deutsch', languageEnglish: 'English', languageItalian: 'Italiano', formTitle: 'Enter production data', storageNote: 'Stored locally', date: 'Date', project: 'Project', part: 'Part', machine: 'Machine', targetPerDay: 'Daily target quantity', targetUnreleased: 'No released target quantity yet', entriesWithoutTarget: 'Entries without released target quantity', producedQty: 'Produced quantity', scrap: 'Scrap', optionalOee: 'Optional OEE data', showOeeData: 'Show OEE data', hideOeeData: 'Hide OEE data', oeeHelp: 'Only fill in if OEE should be calculated.', showOeeColumns: 'Show OEE columns', hideOeeColumns: 'Hide OEE columns', optional: '(optional)', plannedTime: 'Planned production time in minutes', downtime: 'Machine downtime in minutes', cycleTime: 'Ideal cycle time per part in seconds', comment: 'Comment', commentField: 'Comment for deviation > 10%, scrap or downtime', saveEntry: 'Save entry', manageMasterData: 'Manage master data', masterNote: 'The app starts without sample master data. New projects, parts and machines are created by saving, manual addition or CSV import.', newProject: 'New project', newPart: 'New part', newMachine: 'New machine', addProject: 'Add project', addPart: 'Add part', addMachine: 'Add machine', projectList: 'Project list', partList: 'Part list', machineList: 'Machine list', managementSummary: 'Management summary', totalGood: 'Total good parts', totalScrap: 'Total scrap', totalDeviation: 'Total deviation', avgAchievement: 'Avg. target achievement', avgAvailability: 'Avg. availability', avgPerformance: 'Avg. performance', avgQuality: 'Avg. quality', avgOee: 'Avg. OEE from valid OEE entries', oeeCount: 'Entries with OEE calculation', noOeeCount: 'Entries without OEE calculation', manageData: 'Manage data', exportCsv: 'Export CSV', exportSummary: 'Export management TXT', importCsv: 'Import CSV', downloadCsvTemplate: 'Download CSV template', dailyOverview: 'Daily overview', categorySums: 'Totals by category', dashboard: 'Dashboard', autoCharts: 'Automatically updated bar charts', projectFilter: 'Project filter', partFilter: 'Part filter', machineFilter: 'Machine filter', goodPerDay: 'Good parts per day', targetVsGood: 'Target quantity vs. good parts per day', scrapPerDay: 'Scrap per day', oeePerDay: 'OEE per day', oeePartsPerDay: 'OEE components per day', showOeeCharts: 'Show OEE charts', hideOeeCharts: 'Hide OEE charts', cumulativeDeviation: 'Cumulative deviation', allEntries: 'All entries', entries: 'entries', noData: 'No data available yet.', noDataSummary: 'No data available yet. Enter or import production data to get a summary.', allProjects: 'All projects', allParts: 'All parts', allMachines: 'All machines', target: 'Target', targetQty: 'Target quantity', produced: 'Produced', good: 'Good parts', deviation: 'Deviation', targetPct: 'Target achievement', targetAchievement: 'Target achievement', availability: 'Availability', performance: 'Performance', quality: 'Quality', planTime: 'Plan time', downtimeShort: 'Downtime', cycleTimeShort: 'Cycle time', availabilityShort: 'Avail.', oeePct: 'OEE %', action: 'Action', delete: 'Delete', rename: 'Rename', active: 'Active', archived: 'Archived', changedOn: 'changed on', goodShort: 'Good', deviationShort: 'Dev.', noOeeData: 'No OEE data available', invalidInput: 'Invalid input.', noValue: 'No value', confirmDeleteEntry: 'Really delete this entry?', importSuccess: 'CSV imported successfully.', validationDate: 'Please enter a date.', validationProject: 'Please enter or select a project.', validationPart: 'Please enter or select a part.', validationMachine: 'Please enter or select a machine.', validationComment: 'Please add a short comment in case of deviation, scrap or downtime.', validationRequiredNumbers: 'Please enter valid numbers for target quantity, produced quantity and scrap.', validationNegative: 'Negative values are not allowed. Please correct the input.', validationTargetPositive: 'The target quantity per day must be greater than 0.', validationProducedPositive: 'The produced quantity must be 0 or higher.', validationScrapTooHigh: 'Scrap must not be greater than produced quantity.', validationPlannedPositive: 'For OEE calculation, planned production time must be greater than 0 minutes.', validationDowntimePositive: 'For OEE calculation, machine downtime must be 0 or higher.', validationCyclePositive: 'For OEE calculation, ideal cycle time must be greater than 0 seconds.', validationDowntimeTooHigh: 'Machine downtime must not be greater than planned production time.', placeholderProject: 'Enter or select project', placeholderPart: 'Enter or select part', placeholderMachine: 'Enter or select machine', placeholderPlanned: 'e.g. 480', placeholderDowntime: 'e.g. 15', placeholderCycle: 'e.g. 1.2', placeholderComment: 'Please enter the reason or a short explanation', placeholderNewProject: 'Enter project name', placeholderNewPart: 'Enter part name', placeholderNewMachine: 'Enter machine name', noProjects: 'No projects available', noParts: 'No parts available', noMachines: 'No machines available', dangerZoneTitle: 'Danger zone', dangerZoneHint: 'Here you can delete all locally stored app data from this browser.', resetAppButton: 'Reset app', resetConfirmMessage: 'Do you really want to delete all locally stored app data? This action cannot be undone.', resetConfirmInstruction: 'Please type RESET to confirm deletion.', resetCancelButton: 'Cancel', resetDeleteButton: 'Delete permanently', footerCredit: 'Production Tracking App · Concept & Prototype by JSE · 2026', footerDocumentation: 'Documentation'
  }
};

const italianTranslations = {
  documentTitle: 'Analisi locale delle quantità di produzione e OEE', languageAria: 'Seleziona lingua', headerEyebrow: 'STRUMENTO DI MONITORAGGIO RAMP-UP', headerTitle: 'Production Ramp-up Tracker', headerSubtitle: 'Raccogliere i dati di produzione giornalieri, identificare gli scostamenti e creare trasparenza durante il ramp-up.', headerNotice: 'App di test aperta – inserire solo dati di produzione approvati. Non inserire dati personali.', workflowHint: 'Flusso di lavoro gestione dati', workflowStepEnter: 'Inserire dati', workflowStepCheck: 'Controllare le voci', workflowStepExport: 'Esporta CSV', workflowStepSend: 'Inviare CSV via e-mail', languageLabel: 'Lingua', languageGerman: 'Deutsch', languageEnglish: 'English', languageItalian: 'Italiano', formTitle: 'Inserisci dati di produzione', storageNote: 'Salvato localmente', date: 'Data', project: 'Progetto', part: 'Componente', machine: 'Macchina', targetPerDay: 'Quantità target giornaliera', targetUnreleased: 'Nessuna quantità target rilasciata', entriesWithoutTarget: 'Voci senza quantità target rilasciata', producedQty: 'Quantità prodotta', scrap: 'Scarto', optionalOee: 'Dati OEE opzionali', showOeeData: 'Mostra dati OEE', hideOeeData: 'Nascondi dati OEE', oeeHelp: 'Compilare solo se deve essere calcolato l’OEE.', showOeeColumns: 'Mostra colonne OEE', hideOeeColumns: 'Nascondi colonne OEE', optional: '(opzionale)', plannedTime: 'Tempo di produzione pianificato in minuti', downtime: 'Fermo macchina in minuti', cycleTime: 'Tempo ciclo ideale per pezzo in secondi', comment: 'Commento', commentField: 'Commento in caso di scostamento > 10%, scarto o fermo macchina', saveEntry: 'Salva voce', manageMasterData: 'Gestisci dati master', masterNote: 'L’app si avvia senza dati master di esempio. Nuovi progetti, componenti e macchine vengono creati salvando, aggiungendo manualmente o importando CSV.', newProject: 'Nuovo progetto', newPart: 'Nuovo componente', newMachine: 'Nuova macchina', addProject: 'Aggiungi progetto', addPart: 'Aggiungi componente', addMachine: 'Aggiungi macchina', projectList: 'Lista progetti', partList: 'Lista componenti', machineList: 'Lista macchine', managementSummary: 'Riepilogo per il management', totalGood: 'Totale pezzi buoni', totalScrap: 'Totale scarto', totalDeviation: 'Scostamento totale', avgAchievement: 'Ø raggiungimento target', avgAvailability: 'Ø disponibilità', avgPerformance: 'Ø performance', avgQuality: 'Ø qualità', avgOee: 'Ø OEE da voci OEE valide', oeeCount: 'Voci con calcolo OEE', noOeeCount: 'Voci senza calcolo OEE', manageData: 'Gestisci dati', exportCsv: 'Esporta CSV', exportSummary: 'Esporta TXT management', importCsv: 'Importa CSV', downloadCsvTemplate: 'Scarica modello CSV', dailyOverview: 'Panoramica giornaliera', categorySums: 'Totali per categoria', dashboard: 'Dashboard', autoCharts: 'Grafici a barre aggiornati automaticamente', projectFilter: 'Filtro progetto', partFilter: 'Filtro componente', machineFilter: 'Filtro macchina', goodPerDay: 'Pezzi buoni per giorno', targetVsGood: 'Quantità target vs. pezzi buoni per giorno', scrapPerDay: 'Scarto per giorno', oeePerDay: 'OEE per giorno', oeePartsPerDay: 'Componenti OEE per giorno', showOeeCharts: 'Mostra grafici OEE', hideOeeCharts: 'Nascondi grafici OEE', cumulativeDeviation: 'Scostamento cumulato', allEntries: 'Tutte le voci', entries: 'Voci', noData: 'Non sono ancora presenti dati', noDataSummary: 'Non sono ancora presenti dati. Inserire o importare dati di produzione per ottenere un riepilogo.', allProjects: 'Tutti i progetti', allParts: 'Tutti i componenti', allMachines: 'Tutte le macchine', target: 'Target', targetQty: 'Quantità target', produced: 'Prodotto', good: 'Pezzi buoni', deviation: 'Scostamento', targetPct: 'Raggiungimento target', targetAchievement: 'Raggiungimento target', availability: 'Disponibilità', performance: 'Performance', quality: 'Qualità', planTime: 'Tempo pianificato', downtimeShort: 'Fermo', cycleTimeShort: 'Tempo ciclo', availabilityShort: 'Dispon.', oeePct: 'OEE %', action: 'Azione', delete: 'Elimina', rename: 'Rinomina', active: 'Attivo', archived: 'Archiviato', changedOn: 'modificato il', goodShort: 'Buoni', deviationShort: 'Scost.', noOeeData: 'Nessun dato OEE disponibile', invalidInput: 'Inserimento non valido.', noValue: 'Nessun valore', confirmDeleteEntry: 'Eliminare davvero questa voce?', importSuccess: 'CSV importato correttamente.', validationDate: 'Inserire una data.', validationProject: 'Inserisci o seleziona un progetto.', validationPart: 'Inserisci o seleziona un componente.', validationMachine: 'Inserisci o seleziona una macchina.', validationComment: 'Inserire un breve commento in caso di scostamento, scarto o fermo.', validationRequiredNumbers: 'Inserire numeri validi per quantità target, quantità prodotta e scarto.', validationNegative: 'I valori negativi non sono consentiti. Correggere l’inserimento.', validationTargetPositive: 'La quantità target giornaliera deve essere maggiore di 0.', validationProducedPositive: 'La quantità prodotta deve essere maggiore o uguale a 0.', validationScrapTooHigh: 'Lo scarto non può essere maggiore della quantità prodotta.', validationPlannedPositive: 'Per il calcolo OEE, il tempo di produzione pianificato deve essere maggiore di 0 minuti.', validationDowntimePositive: 'Per il calcolo OEE, il fermo macchina deve essere maggiore o uguale a 0 minuti.', validationCyclePositive: 'Per il calcolo OEE, il tempo ciclo ideale deve essere maggiore di 0 secondi.', validationDowntimeTooHigh: 'Il fermo macchina non può essere maggiore del tempo di produzione pianificato.', placeholderProject: 'Inserisci o seleziona un progetto', placeholderPart: 'Inserisci o seleziona un componente', placeholderMachine: 'Inserisci o seleziona una macchina', placeholderPlanned: 'es. 480', placeholderDowntime: 'es. 15', placeholderCycle: 'es. 1,2', placeholderComment: 'Inserire la causa o una breve spiegazione', placeholderNewProject: 'Inserisci nome progetto', placeholderNewPart: 'Inserisci nome componente', placeholderNewMachine: 'Inserisci nome macchina', noProjects: 'Nessun progetto disponibile', noParts: 'Nessun componente disponibile', noMachines: 'Nessuna macchina disponibile', dangerZoneTitle: 'Area critica', dangerZoneHint: 'Qui è possibile eliminare tutti i dati dell’app salvati localmente in questo browser.', resetAppButton: 'Ripristina app', resetConfirmMessage: 'Vuoi davvero eliminare tutti i dati dell’app salvati localmente? Questa azione non può essere annullata.', resetConfirmInstruction: 'Inserisci RESET per confermare l’eliminazione.', resetCancelButton: 'Annulla', resetDeleteButton: 'Elimina definitivamente', footerCredit: 'Production Tracking App · Concept & Prototype by JSE · 2026', footerDocumentation: 'Documentazione'
};
translations.it = { ...translations.de, ...italianTranslations };
...
Object.assign(translations.it, {
  validateData: 'Controlla dati', dataValidationOk: 'Nessuna anomalia trovata.', dataValidationIssues: 'Anomalie trovate:', entry: 'Voce', validationProjectMissingShort: 'Verificare che sia presente un progetto.', validationPartMissingShort: 'Verificare che sia presente un componente.', validationMachineMissingShort: 'Verificare che sia presente una macchina.', validationScrapNonNegative: 'Lo scarto deve essere maggiore o uguale a 0.', validationOeePartial: 'I dati OEE sono compilati parzialmente. Per un calcolo OEE, completare tempo pianificato, fermo e tempo ciclo.',
  periodFilter: 'Periodo', allData: 'Tutti i dati', last7Days: 'Ultimi 7 giorni', last14Days: 'Ultimi 14 giorni', last30Days: 'Ultimi 30 giorni', currentCalendarWeek: 'Settimana di calendario corrente', lastCalendarWeek: 'Ultima settimana di calendario', customPeriod: 'Periodo personalizzato', displayMode: 'Visualizzazione', dailyValues: 'Valori giornalieri', weeklyValues: 'Valori settimanali', monthlyValues: 'Valori mensili', periodFrom: 'Da', periodTo: 'A', chartRecommendation: 'Con molti giorni consigliamo valori settimanali o mensili per una migliore leggibilità.', calendarWeekShort: 'Sett.'
});
...
Object.assign(translations.it, {
  infoButton: 'ⓘ Info / Guida', infoCloseAria: 'Chiudi finestra info', infoTitle: 'Come usare questa app', infoIntro: 'Questa app serve per inserire in modo semplice i dati di produzione giornalieri. I dati vengono salvati localmente nel browser e non vengono inviati automaticamente.', infoWorkflowTitle: 'Flusso di lavoro', infoWorkflow1: 'Inserire i dati di produzione', infoWorkflow2: 'Salvare la voce', infoWorkflow3: 'Controllare le voci', infoWorkflow4: 'Esportare il CSV', infoWorkflow5: 'Inviare il file CSV via e-mail', infoNotesTitle: 'Note importanti', infoNote1: 'Questa è un’app di test aperta.', infoNote2: 'Inserire solo dati di produzione approvati per questo utilizzo.', infoNote3: 'Non inserire dati personali.', infoNote4: 'I dati rimangono salvati localmente nel browser di questo dispositivo.', infoNote5: 'Se l’app viene aperta su un altro dispositivo, i dati salvati localmente non sono disponibili automaticamente.', infoOeeTitle: 'Dati OEE opzionali', infoOeeText: 'I dati OEE devono essere compilati solo se deve essere calcolato l’OEE. Se non vengono inseriti dati OEE, l’app mostra n/a per gli indicatori OEE.', infoCsvTitle: 'CSV', infoCsvText: 'Con Esporta CSV è possibile scaricare i dati inseriti e inviarli successivamente via e-mail. Con Importa CSV è possibile caricare nuovamente dati CSV esistenti.', infoResetTitle: 'Ripristina app', infoResetText: 'Con Ripristina app è possibile eliminare tutti i dati salvati localmente in questo browser. Questa operazione non può essere annullata.', infoCloseButton: 'Chiudi'
});
Object.assign(translations.en, {
...
function applyTranslations() {
  ...
  if (languageSelect) {
    ...
    const italianOption = languageSelect.querySelector('option[value="it"]');
    if (germanOption) germanOption.textContent = t('languageGerman');
    if (englishOption) englishOption.textContent = t('languageEnglish');
    if (italianOption) italianOption.textContent = t('languageItalian');
  }
  ...
  updateOeeChartsToggle();
  document.querySelectorAll('.kpi span').forEach((element, index) => { const keys = ['totalGood','totalScrap','totalDeviation','avgAchievement','entriesWithoutTarget','avgAvailability','avgPerformance','avgQuality','avgOee','oeeCount','noOeeCount']; element.textContent = t(keys[index]); });
...
const requiredNumberFields = ['produced','scrap'];
...
const oeeChartsToggle = document.querySelector('#oee-charts-toggle');
const oeeChartsContent = document.querySelector('#oee-charts-content');
const languageSelect = ensureLanguageSwitcher();
const targetInput = document.querySelector('#target');
const targetUnreleasedInput = document.querySelector('#target-unreleased');
...
updateTargetReleaseState();
form.addEventListener('submit', saveEntry);
if (targetUnreleasedInput) targetUnreleasedInput.addEventListener('change', updateTargetReleaseState);
...
if (oeeChartsToggle) oeeChartsToggle.addEventListener('click', toggleOeeCharts);
...
function persistOeeChartsPreference() {
  localStorage.setItem(OEE_CHARTS_STORAGE_KEY, showOeeCharts ? 'expanded' : 'collapsed');
}

function toggleOeeCharts() {
  showOeeCharts = !showOeeCharts;
  persistOeeChartsPreference();
  updateOeeChartsToggle();
  if (showOeeCharts) renderCharts(filteredRows());
}

function updateOeeChartsToggle() {
  if (!oeeChartsToggle || !oeeChartsContent) return;
  oeeChartsToggle.setAttribute('aria-expanded', String(showOeeCharts));
  const label = t(showOeeCharts ? 'hideOeeCharts' : 'showOeeCharts');
  const labelElement = oeeChartsToggle.querySelector('#oee-charts-title');
  if (labelElement) labelElement.textContent = label;
  oeeChartsContent.hidden = !showOeeCharts;
}
...
function updateTargetReleaseState() {
  if (!targetInput || !targetUnreleasedInput) return;
  const unreleased = targetUnreleasedInput.checked;
  targetInput.disabled = unreleased;
  targetInput.required = !unreleased;
  targetInput.placeholder = unreleased ? NA_LABEL : '';
  targetInput.value = unreleased ? '' : targetInput.value;
  targetInput.closest('.target-field')?.classList.toggle('target-unreleased-active', unreleased);
}
...
function saveEntry(event) {
  ...
  const entry = {
    ...
    target: targetUnreleasedInput?.checked ? null : getNumber('target'), produced: getNumber('produced'), scrap: getNumber('scrap'), plannedTime: getOptionalNumber('plannedTime'),
...
function validateEntry(entry) {
  ...
  if (entry.target !== null && !Number.isFinite(entry.target)) return t('validationRequiredNumbers');
  if ([...requiredNumberFields, 'target'].some((field) => entry[field] !== null && entry[field] < 0) || oeeNumberFields.some((field) => entry[field] !== null && entry[field] < 0)) return t('validationNegative');
  if (entry.target !== null && entry.target <= 0) return t('validationTargetPositive');
  if (entry.produced < 0) return t('validationProducedPositive');
  if (entry.scrap > entry.produced) return t('validationScrapTooHigh');
  if (requiresComment(entry) && !entry.comment) return t('validationComment');
...
function requiresComment(entry) {
  const normalized = normalizeEntry(entry);
  if (!Number.isFinite(normalized.target) || normalized.target <= 0 || !Number.isFinite(normalized.produced) || !Number.isFinite(normalized.scrap)) return false;
  const good = normalized.produced - normalized.scrap;
  const deviation = good - normalized.target;
  const achievement = (good / normalized.target) * 100;
  return achievement < 90 || deviation < 0 || normalized.scrap > 0 || (Number.isFinite(normalized.downtime) && normalized.downtime > 0);
}

function enrich(entry) {
  const normalized = normalizeEntry(entry);
  const good = normalized.produced - normalized.scrap;
  const hasReleasedTarget = Number.isFinite(normalized.target) && normalized.target > 0;
  const deviation = hasReleasedTarget ? good - normalized.target : null;
  const achievement = hasReleasedTarget ? (good / normalized.target) * 100 : null;
...
function normalizeEntry(entry) {
  return { ...entry, project: normalizeText(entry.project), part: normalizeText(entry.part), machine: normalizeText(entry.machine), target: toOptionalNumber(entry.target), produced: toNumber(entry.produced), scrap: toNumber(entry.scrap), plannedTime: toOptionalNumber(entry.plannedTime), downtime: toOptionalNumber(entry.downtime), cycleTime: toOptionalNumber(entry.cycleTime) };
}
...
function renderTable(rows) {
  ...
  entriesBody.innerHTML = rows.map((e) => {
    ...
    <tr class="${e.oeeWarning && showTableOeeColumns ? 'warning-row' : ''}">
      ...
      <td>${formatTarget(e.target)}</td><td>${formatInteger(e.produced)}</td><td>${formatInteger(e.scrap)}</td><td>${formatInteger(e.good)}</td><td>${formatNullableInteger(e.deviation)}</td><td>${formatPercentHtml(e.achievement)}</td>
      ${oeeCells}
...
function renderTotals(rows) {
  ...
  setKpiText('#total-good', formatInteger(totals.good)); setKpiText('#total-scrap', formatInteger(totals.scrap)); setKpiText('#total-deviation', formatNullableInteger(totals.deviation));
  ...
  setKpiText('#no-target-count', formatInteger(rows.filter((r) => !isCalculable(r.target)).length));
...
function buildManagementSummary(rows) {
  ...
  const totals = aggregate(rows), withoutTarget = rows.filter((r) => !isCalculable(r.target)).length, redTargets = rows.filter((r) => r.targetStatus === 'red').length, warnings = rows.filter((r) => r.oeeWarning).length;
  ...
  if (currentLanguage === 'it') {
    const targetGapText = withoutTarget ? ` ${formatInteger(withoutTarget)} voci non hanno ancora una quantità target rilasciata e sono escluse dal raggiungimento target medio.` : '';
...
function aggregate(rows) { const sums = sumRows(rows); const targetRows = rows.filter((r) => isCalculable(r.target) && r.target > 0); return { ...sums, deviation: targetRows.length ? sums.deviation : null, achievement: targetRows.length ? avg(targetRows, 'achievement') : null, availability: avg(rows, 'availability'), performance: avg(rows, 'performance'), quality: avg(rows, 'quality'), oee: avg(rows, 'oee') }; }
function sumRows(rows) { return rows.reduce((s, r) => ({ target: s.target + (isCalculable(r.target) ? r.target : 0), good: s.good + r.good, scrap: s.scrap + r.scrap, deviation: isCalculable(r.deviation) ? s.deviation + r.deviation : s.deviation }), { target: 0, good: 0, scrap: 0, deviation: 0 }); }
...
function collectEntryValidationMessages(entry) {
  ...
  if (entry.target !== null && (!Number.isFinite(entry.target) || entry.target <= 0)) messages.push(t('validationTargetPositive'));
  ...
  if (requiresComment(entry) && !String(entry.comment || '').trim()) messages.push(t('validationComment'));
...
function formatTarget(value) { return isCalculable(value) ? formatInteger(value) : formatNa(); }
function formatNullableInteger(value) { return isCalculable(value) ? formatInteger(value) : formatNa(); }
function formatPercentHtml(value) { return isCalculable(value) ? formatPercent(value) : formatNa(); }
function formatCsvTarget(value) { return isCalculable(value) ? value : NA_LABEL; }
function parseImportedTarget(value) { const clean = String(value ?? '').trim().toLowerCase(); return clean === '' || clean === NA_LABEL ? null : toOptionalNumber(value); }
