...
function clearAllEntries() {
  ...
  [STORAGE_KEY, LEGACY_STORAGE_KEY, PROJECT_STORAGE_KEY, PART_STORAGE_KEY, MACHINE_STORAGE_KEY, DELETED_MASTER_STORAGE_KEY].forEach((key) => localStorage.removeItem(key));
  resetProductionForm();
